...
static int magician_hp_switch = 0;
...
{
	snd_soc_dapm_set_endpoint(codec, "Speaker", magician_spk_switch);
	snd_soc_dapm_set_endpoint(codec, "Headphone Jack", magician_hp_switch);
...
static const struct snd_kcontrol_new uda1380_magician_controls[] = {
	SOC_SINGLE_BOOL_EXT("Headphone Switch", &magician_hp_switch,
			magician_get_hp, magician_set_hp),
	SOC_SINGLE_BOOL_EXT("Speaker Switch", &magician_spk_switch,
