...
#define GPIO18_MAGICIAN_UNKNOWN			18	/* unknown output */
...
#define GPIO40_MAGICIAN_GSM_OUT2		40	/* FFDTR? */
#define GPIO48_MAGICIAN_UNKNOWN			48	/* unknown output */
#define GPIO56_MAGICIAN_UNKNOWN			56	/* unknown output */
#define GPIO57_MAGICIAN_UNKNOWN			57	/* unknown output */
...
#define GPIO116_MAGICIAN_UNKNOWN		116	/* unknown output */
...
//#define GPIO26_SRXD_MD			(26 | GPIO_ALT_FN_1_IN)		/* FIXME: GSM_OUT? */
...
#define GPIO53_CIF_MCLK_MD			(53 | GPIO_ALT_FN_2_OUT)	/* FIXME! */
#define GPIO53_SSP1SYSCLK_MD			(53 | GPIO_ALT_FN_3_OUT)	/* which is it? */
...
#define GPIO57_MAGICIAN_UNKNOWN_MD		(57 | GPIO_OUT)
...
#define GPIO116_MAGICIAN_UNKNOWN_MD		(116 | GPIO_OUT) /* 1 */
...
#define EGPIO2_MAGICIAN_TOPPOLY_POWER		2	/* 0x040000 */ /* ?? */
#define EGPIO_NR_MAGICIAN_LED_POWER		5	/* 0x200000 */
#define EGPIO_NR_MAGICIAN_GSM_RESET		6	/* 0x400000 */
#define EGPIO_NR_MAGICIAN_LCD_POWER		7	/* 0x800000 */
#define EGPIO_NR_MAGICIAN_SPK_POWER		(1*16+0)	/* 0x0001 */
#define EGPIO_NR_MAGICIAN_EP_POWER		(1*16+1)	/* 0x0002 */
#define EGPIO_NR_MAGICIAN_IN_SEL0		(1*16+2)	/* 0x0004 */
#define EGPIO_NR_MAGICIAN_IN_SEL1		(1*16+3)	/* 0x0008 */
#define EGPIO_NR_MAGICIAN_MIC_POWER		(1*16+4)	/* 0x0010 */
#define EGPIO_NR_MAGICIAN_CODEC_RESET		(1*16+5)	/* 0x0020 */
#define EGPIO_NR_MAGICIAN_CODEC_POWER		(1*16+6)	/* 0x0040 */
#define EGPIO_NR_MAGICIAN_BL_POWER		(1*16+7)	/* 0x0080 */
#define EGPIO_NR_MAGICIAN_SD_POWER		(2*16+0)	/* 0x0100 */
#define EGPIO_NR_MAGICIAN_CARKIT_MIC		(2*16+1)	/* 0x0200 */
#define EGPIO_NR_MAGICIAN_UNKNOWN_WAVEDEV_DLL	(2*16+2)	/* 0x0400 */
#define EGPIO_NR_MAGICIAN_FLASH_VPP		(2*16+3)	/* 0x0800 */
#define EGPIO_NR_MAGICIAN_BL_POWER2		(2*16+4)	/* 0x1000 */
#define EGPIO_NR_MAGICIAN_CHARGE_EN		(2*16+5)	/* 0x2000 <-- set by wince SleepSetting if cable_state == 5 */
#define EGPIO_NR_MAGICIAN_GSM_POWER		(2*16+7)	/* 0x8000 */

/* input */

#define EGPIO_NR_MAGICIAN_CABLE_STATE_AC	(4*16+0)
#define EGPIO_NR_MAGICIAN_CABLE_STATE_USB	(4*16+1)

#define EGPIO_NR_MAGICIAN_BOARD_ID0		(5*16+0)
#define EGPIO_NR_MAGICIAN_BOARD_ID1		(5*16+1)
#define EGPIO_NR_MAGICIAN_BOARD_ID2		(5*16+2)
#define EGPIO_NR_MAGICIAN_LCD_SELECT		(5*16+3)
#define EGPIO_NR_MAGICIAN_nSD_READONLY		(5*16+4)

/* Compatibility wrappers */
extern void magician_egpio_set(int bit, int value);
extern int magician_egpio_get(int bit);
